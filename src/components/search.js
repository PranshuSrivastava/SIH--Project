...
export default function Search() {
  ...
  var languagem = ['Hindi', 'English', 'Urdu', 'Tamil', 'Telgu', 'Punjabi', 'Haryanavi', 'Sankrit']



  var fieldsm = ['English', 'Hindi', 'Mathematics', 'Computer Science', 'Social Studies', 'Economics', 'History', 'Political Science', 'Geography', 'Psychology', 'Biology', 'Chemistry', 'Physics', 'Engineering Graphics', 'Accounts', 'Business Management']
    ...
    <div className="search_main">
      <form className="frm">
        ...
        <div className="keyworddiv" style={{ width: "60%" }}>
          ...
          <div className="keyword_div">
            <button onClick={(event) => { selectClick(event, 3) }} className="keyword_btn" >Subjects</button>
